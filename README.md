...
- **Update Status & Prioritas** → Mengubah status baca dan tingkat prioritas buku.
- **Hapus Buku** → Menghapus data buku berdasarkan ID.
- **Statistik** → Menampilkan ringkasan jumlah buku berdasarkan status dan prioritas, serta progress membaca.
- **Simpan & Muat Data** → Data disimpan ke file `library_data.txt` agar tidak hilang saat program ditutup.
